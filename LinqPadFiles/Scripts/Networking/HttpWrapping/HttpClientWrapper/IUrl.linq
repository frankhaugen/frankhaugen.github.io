...
public interface IUrl
{
    ...
    /// <summary>
    /// Gets or sets the fragment of the URL (e.g. "#fragment").
    /// </summary>
    string Fragment { get; }
    ...
    /// </summary>
    /// <param name="queryParams">The query parameters to add to the URL as a list of key-value pairs (e.g. "key1=value1&key2=value2").</param>
    ...
    /// </summary>
    /// <param name="fragment">The fragment to add to the URL (e.g. "#fragment").</param>
    /// <returns>The URL with the added fragment.</returns>
    IUrl AddFragment(string fragment);
