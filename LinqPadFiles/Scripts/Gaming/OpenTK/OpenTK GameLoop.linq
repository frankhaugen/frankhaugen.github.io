<Query Kind="Statements">
  <NuGetReference Version="4.7.4">OpenTK</NuGetReference>
  <Namespace>OpenTK.Graphics.OpenGL4</Namespace>
...
//    game.Run();
//}
using (var window = new Window(GameWindowSettings.Default, NativeWindowSettings.Default))
{
    window.Run();
}
...
public class Window : GameWindow
{
    ...
    protected override void OnLoad()
    {
        ...
        _shader = new Shader(Shaders.GetV(), Shaders.GetF());
...
{
    private static string _basePath = @"C:\repos\frankhaugen\frankhaugen.github.io\LinqPadFiles\Scripts\Gaming\OpenTK";
    
    public static string GetF() => File.ReadAllText(Path.Combine(_basePath, "Shaders/shader.vert"));

    public static string GetV() => File.ReadAllText(Path.Combine(_basePath, "Shaders/shader.frag"));
}